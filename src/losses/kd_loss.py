...
class KDLossMetric(mx.metric.EvalMetric):
    def __init__(self):
        super(KDLossMetric, self).__init__('center_loss')
...
class KDLoss(mx.operator.CustomOp):
...
@mx.operator.register("kdloss")
class KDLossProp(mx.operator.CustomOpProp):
    ...
    def create_operator(self, ctx, shapes, dtypes):
        return KDLoss(ctx, shapes, dtypes, self.num_class, self.alpha, self.scale)
